...
df = pd.read_csv("top50_spotify_songs_GLB.csv")#opens the csv file into a dataframe
...
plt.title("Top 10 Popular Spotify Songs of January Globally")
...
plt.title("Top 10 Popular Spotify Songs of February Globally")
...
plt.title("Top 10 Popular Spotify Songs of March Globally")
...
plt.title("Top 10 Popular Spotify Songs of April Globally")
...
plt.title("Top 10 Popular Spotify Songs of May Globally")
...
plt.title("Top 10 Popular Spotify Songs of June Globally")
...
plt.title("Top 10 Popular Spotify Songs of July Globally")
...
plt.title("Top 10 Popular Spotify Songs of August Globally")
...
plt.title("Top 10 Popular Spotify Songs of September Globally")
...
plt.title("Top 10 Popular Spotify Songs of October Globally")
...
plt.title("Top 10 Popular Spotify Songs of November Globally")
...
plt.title("Top 10 Popular Spotify Songs of December Globally")
